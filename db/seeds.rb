...
list_1 = List.create(name: "liste 1")
Bookmark.create(list: list_1, comment: "heyyyyyy", movie: movie_1)
Bookmark.create(list: list_1, comment: "heddiiiiiy", movie: movie_2)

list_2 = List.create(name: "liste 2")
Bookmark.create(list: list_2, comment: "heeeeedddy", movie: movie_3)
Bookmark.create(list: list_2, comment: "heddddddy", movie: movie_4)
